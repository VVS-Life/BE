...
public enum ErrorHandling {
    ...
    IS_EMPTY_REPLY_LIST(HttpStatus.BAD_REQUEST.value(), "해당 답글 리스트가 없습니다"),
    ...
    NOT_FOUND_BOARD_ID(HttpStatus.BAD_REQUEST.value(), "해당 게시글이 존재하지 않습니다"),
    NOT_FOUND_REPLY(HttpStatus.BAD_REQUEST.value(),"해당 답글이 존재하지 않습니다"),
    NOT_FOUND_PRODUCT(HttpStatus.BAD_REQUEST.value(), "해당 상품이 없습니다"),
    ...
    DUPLICATE_SUBSCRIPTION(HttpStatus.BAD_REQUEST.value(), "이미 가입한 상품입니다");
