...
public class AwsS3Service {
    ...
    public AwsS3 upload(MultipartFile multipartFile, String dirName) throws IOException {
        File file = convertMultiFileToFile(multipartFile)
                .orElseThrow(() -> new ApiException(FILE_CONVERSION_FAILURE));
    ...
    public Optional<File> convertMultiFileToFile(MultipartFile multipartFile) throws IOException {
